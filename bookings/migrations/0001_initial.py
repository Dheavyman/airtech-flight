    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_status', models.CharField(choices=[('B', 'Booked'), ('R', 'Reserved'), ('C', 'Cancelled')], default='B', max_length=1)),
                ...
                ('amount_paid', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=19)),
